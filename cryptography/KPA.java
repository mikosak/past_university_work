...
public class KPA {
	...
	public static void main(String[] args) {
		String ciphertext = "jc4DFCdyO/Wx6Tek/j[.c<X&57o8E3$IWw\\-LN@Tr}L}(0$]k9N_2kPuG5bx)q^1!#bFqBdMv?`Stl^yNEwI@U_Q}:y&}-,U((48ma\\62!$:~&r{lSL7`mdv08p WIbLbId,ZlO29H~vR3zy9Ah:AxiAym{\"ZWa|:KSP/=;(Od:^vsya7J\\_gqI5I[osj)$<MX;jz+s$:>cEY!8U9Xxo%FldV~\"Lm6%-L,ETmSd(pvP_sBIpGT.Rdiuk~=GIQNe4+7WvM`rhrxk";

        try (
        BufferedReader reader = new BufferedReader(new FileReader("passwords"));
        PrintWriter writer = new PrintWriter(new FileWriter("kpa_output"))
        ) {
        String key;
        while ((key = reader.readLine()) != null) {
            ...
            if (decrypted.startsWith("We")) {
                writer.println("Key: " + key);
                writer.println("Decrypted Text: " + decrypted);
                writer.println("-------------------------------------------------");
            }
        }
        System.out.println("KPA complete. Check 'kpa_output' for results.");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
