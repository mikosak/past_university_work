...
public class COA {
	...
	public static void main(String[] args) {
		String ciphertext = "F{qQ,Fg*Ve{U}!1;E]1C#3[mAzJNiI6@8Y/AA&\\Cy?[A1~l[i/'BvZz.P_dV2<;&]n@}pRYinw,.\"b/A3G& plR_DL~|uCur{'^b4`sa(<Amn0WB)Ikv;9^oH7ywwFnk,`%A6hX*w6we?>:!m-+<#}?Bw3W'nfZ2vE\"<`p_07]xl])g\\y5c>=q/2_EIb93u_d-|aZ~fxHVsAu(B`Gs'0@:=ssh#,96`O7A=({s-5>elF<TLRq$tA[B=\\VMu#ls.Y<6Wf_07c \"yNn3vOGzG JJPb{cpdk63Xvfh;'IR+NyHis~rsM4K~ToSRfYfFO'i/`#>j}Awp6eIkY!LJBv YOBhOmy!*82}o#bR]L;^}h$ak7<FdR1-Qj_*\\Mb£\\lJL%u-ces*xyhsB?s~qGFNe>N/8{!";

        try (
            BufferedReader reader = new BufferedReader(new FileReader("passwords"));
            PrintWriter writer = new PrintWriter(new FileWriter("coa_output"))
        ) {
            String key;
            while ((key = reader.readLine()) != null) {
                ...
                String decrypted = encdec(DEC, key, ciphertext);
            ...
            System.out.println("Decryption attempts complete. Results saved to 'coa_output'.");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
